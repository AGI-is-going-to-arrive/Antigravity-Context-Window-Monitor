...
面板总框架：标签切换（Monitor / Settings / Activity / Profile / History / GM Data / Pricing）、CSP 安全策略、消息通信。各标签内容由独立模块生成。

Panel framework: tab switching (Monitor / Settings / Activity / Profile / History / GM Data / Pricing), CSP policy, message communication. Each tab's content is generated by independent modules.
